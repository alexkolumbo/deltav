...
Дальше (фаза 7+):
- батчинг запросов в один проход модели (continuous batching);
- embedding-модели на нодах → векторный RAG вместо BM25;
- экономика: комиссия шлюза, рынок цен между нодами;
